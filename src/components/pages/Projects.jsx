...
function Projects() {
  return (
    <Element name="project">
      <section className="w-full h-full bg-[#0C1328] text-white pb-[180px] px-[20px]  ">
        <div className="text-center">
          <h2 className="font-script font-bold text-white text-[40px] ">
            Projects
          </h2>
        </div>
        <div className="mt-[79px] grid grid-cols-2 max-lg:grid-cols-1 gap-[112px] max-xl:gap-[100px] max-lg:gap-[90px] max-w-[1234px] mx-auto ">
          <Projectcomp
